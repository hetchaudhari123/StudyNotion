        ...
        <div className='p-6 flex flex-col  text-richblack-800 gap-5 rounded-lg border border-richblack-700 '>
          ...
          <div className='w-full  flex flex-row gap-1'>
            ...
            <div className='w-1/2 flex flex-col gap-0.5 justify-between  '>
              ...
              <div className='font-inter text-sm font-medium leading-5 text-left text-richblack-5'>{user?.additionalDetails?.gender ?? "Not provided yet!"}</div>

            </div>
            <div className='w-1/2 flex flex-col gap-0.5 justify-between  '>
              <div className='font-inter text-sm font-normal leading-5 text-left text-richblack-600'>Date of Birth</div>

              <div className='font-inter text-sm font-medium leading-5 text-left text-richblack-5'>{user?.additionalDetails?.dateOfBirth ?? "Not provided yet!"}</div>
