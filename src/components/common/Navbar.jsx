                ...
                '>
                    ...
                    bg-richblack-800 cursor-pointer'>
                        ...
                        transition-all duration-200 p-4 rounded-[200px] */}
                            {/* <FaShoppingCart size={26}/> */}
                            {(user?.image) ?
                            (<img onClick={() => navigate('/dashboard')} className='w-[100px] md:w-[50px] aspect-square rounded-full text-richblack-5' src={`${user?.image}`} alt={`${user?.firstName + " " + user?.lastName + " Profile image"}`} />)
